Namespace Model
    ...
    Public Class Borde
        ...
        Private _borde_discount As Decimal
        Private _borde_tax As Decimal
        ...
        Public Sub New(borde_boor_id As Integer, borde_checkin As String, borde_checkout As String, borde_adults As Integer, borde_kids As Integer, borde_price As Double, borde_extra As Double, borde_discount As Decimal, borde_tax As Decimal, borde_subtotal As Double, borde_faci_id As Integer)
        ...
        Public Sub New(borde_id As Integer, borde_boor_id As Integer, borde_checkin As String, borde_checkout As String, borde_adults As Integer, borde_kids As Integer, borde_price As Double, borde_extra As Double, borde_discount As Decimal, borde_tax As Decimal, borde_subtotal As Double, borde_faci_id As Integer)
        ...
        Public Property Borde_discount As Decimal
            Get
        ...
        Public Property Borde_tax As Decimal
            Get
                Return _borde_tax
            End Get
            Set(value As Decimal)
